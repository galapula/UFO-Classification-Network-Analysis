...
shape_list = ['Unspecified', 'changed', 'Changing', 'Chevron', 'Chevron2', 'Cigar', 'Circle', 'Cone', 'Crescent', 'Cross', 'Cylinder', 'Delta', 'Diamond', 'Disk', 'Dome', 'Egg', 'Fireball', 'Flare', 'Flash', 'Formation', 'Hexagon', 'Light', 'Other', 'Oval', 'pyramid', 'Rectangle', 'Round', 'Sphere', 'Teardrop', 'Triangle', 'TRIANGULAR', 'Unknown']
